...
const CompletionProvider_1 = __webpack_require__(34);
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(coc_nvim_1.languages.registerCompletionItemProvider('coc-cssmodules', 'cssmodules', mode.map(x => x.language), new CompletionProvider_1.CSSModulesCompletionProvider(camelCaseConfig), ['.'], undefined, 100));
    });
}
...
class CSSModulesDefinitionProvider {
    ...
    provideDefinition(document, position, _) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentLine = yield nvim.eval('getline(".")');
            if (typeof currentLine !== 'string') {
                return null;
            }
            const matches = utils_1.genImportRegExp('(\\S+)').exec(currentLine);
            if (utils_1.isImportLineMatch(currentLine, matches, position.character)) {
            ...
            const targetPosition = utils_1.getPosition(importPath, field, this._camelCaseConfig);
...
function findImportPath(text, key, parentPath) {
    ...
    if (!!results && results.length > 0) {
        return path_1.default.resolve(parentPath, results[1]);
    }
    else {
        return '';
    }
...
function getTransformer(camelCaseConfig) {
    switch (camelCaseConfig) {
        case true:
            return lodash_camelcase_1.default;
        case 'dashes':
...
function getPosition(filePath, className, camelCaseConfig) {
    ...
    let lineNumber = -1;
    let character = -1;
    const keyWord = camelCaseConfig !== true
        ? // is false or 'dashes'
            `.${className}`
        : className;
    ...
    return lineNumber === -1
        ? null
        : vscode_languageserver_protocol_1.Position.create(lineNumber, character + 1);
}
