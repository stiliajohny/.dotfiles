...
const protocol_sematicTokens_proposed_1 = require("vscode-languageserver-protocol/lib/protocol.sematicTokens.proposed");
/**
    ...
    return {
        capabilities: {
            ...
            semanticTokensProvider: semanticTokensSupport ? {
                legend: {
                    tokenTypes: [
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.keyword,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.comment,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.parameter,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.property,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.label,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.class,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.macro,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.string,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.variable,
                        protocol_sematicTokens_proposed_1.SemanticTokenTypes.operator
                    ],
                    tokenModifiers: [
                        protocol_sematicTokens_proposed_1.SemanticTokenModifiers.declaration,
                        protocol_sematicTokens_proposed_1.SemanticTokenModifiers.definition,
                        protocol_sematicTokens_proposed_1.SemanticTokenModifiers.deprecated,
                        protocol_sematicTokens_proposed_1.SemanticTokenModifiers.reference
                    ]
                }
            } : undefined,
