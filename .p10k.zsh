# Generated by Powerlevel10k configuration wizard on 2020-02-05 at 00:46 GMT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 05731.
# Wizard options: powerline, rainbow, angled separators, blurred heads, sharp tails,
# 2 lines, dotted, full frame, dark-ornaments, compact, concise, transient_prompt,
# instant_prompt=off.
